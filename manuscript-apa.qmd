...
# Source R script used to clean raw data, preferable to reading in exported cleaned data from the script as it preserves the variable types and factor levels
